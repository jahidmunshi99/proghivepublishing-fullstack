...
const Testimonials = () => {
  ...
  return (
    <section
      id="testimonial"
      className="relative overflow-hidden py-24 bg-gradient-to-b from-slate-950 via-sky-950 to-slate-950"
    >
      {/* Glow Background */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-20 grid grid-cols-2 gap-5 md:grid-cols-4">
          {[
            ...
            <div
              key={label}
              className="rounded-3xl border border-white/10 bg-white/5 p-6 text-center backdrop-blur-xl hover:border-cyan-400/20 hover:bg-white/10 transition"
            >
